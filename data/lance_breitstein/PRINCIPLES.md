...
| [Capitulation fade: the ten-variable scorecard](principles/capitulation-ten-variables.md) | setup selection (reversal, both sides) | 2.5/5 | EOD ⭐ (7 of 10) | **yes: FAIL both sides (2026-09-20)** | Fullest statement of his reversal rubric (acceleration, ≥3 days, beyond the BB, no fresh news, volume multiples, more legs, no consolidation, sentiment, **boring = large cap/diversified/index**, forced flows), honest base rate ("the 0.001%"). ⚠ Already measured: deeper extension + volume flush made the counter-trend long WORSE; boring INVERTED, but we built it as own-ADR, not his market-cap/index version (untested). Evidence = famous hindsight tops/bottoms. ⭐ One test: composite score, forward R must be monotone in it, both sides; subsumes the 2×/2× short. `P4Ijq-IJhE8` (SMB talk, 2026-09). |
