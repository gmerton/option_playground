...
| 00:38 | Rules: 45 DTE, 10Δ short ES put, 50% take, manage at 21 DTE, 1 lot per week | **The mechanics are tested here in pieces, never as this exact trade.** (a) **21 DTE vs hold** on a 45-DTE/20Δ strangle, real fills, 44 names: ~~paired +$1.53, t +4.26, PASS, both arms negative (A −2.55 / B −1.02; SPY −$1.77 / −$0.46)~~ (corrected 2026-09-24, FIX-1: original run dropped worthless-expiry winners). Fixed (`exit_21dte_2026-09-23_fixed.csv`): 21-DTE close − hold **−$0.52/share, month-clustered t −2.42** (hold +$0.23, 74% win; 21-DTE −$0.29, 64% win; n 14,367) → PASS: NO. So the 21-DTE rule buys risk (sd $9.33 vs $17.09, worst −$291 vs −$617), not return: managing earns *less* than holding, and the held 20Δ strangle is ≈ flat at real fills. (The SPY-only slice has not been re-derived on the fixed run.) (b) **50% take**: carries the ETF bull put result ("the exit rule is the edge", 45 DTE 0.35/0.25, 50% take, no stop: +5.70%/trade after the ceiling-filter erratum, monthly t 3.13, "substantially long-beta"). (c) **Ungated SPY 45-DTE 0.35/0.25 bull put, 50% take**: n 409, per-trade t 1.9, **monthly t 1.2**, 2018/2022/2026 negative (`project_what_survives`). **Not tested: a naked 10Δ put, and anything on futures options** |
...
| 05:04 | "Don't over-leverage and roll before expiration": the 21-DTE rule *is* the guardrail | **Partly supported.** 21-DTE **cuts the variance** in our test (sd $9.33 vs $17.09, worst −$291 vs −$617 per share; corrected 2026-09-24, FIX-1). That's a risk result, not a return result (on return it costs −$0.52/share vs hold, t −2.42), and it doesn't protect against a gap inside the 45→21 window. **Rolling** as a rescue is contradicted: roll test, 69.8% better held |
...
| 06:17 | "I did this test in a 9% drop and had no losses… the market bounced before I had to roll a negative trade" | **Survivorship of one path.** True only if his first entry was on or after ~2026-03-06 (see audit). In our SPY 21-DTE rows, 2020 is **−$8.48/strangle held, −$3.50 managed** (⚠ from the retracted run that dropped worthless-expiry winners, FIX-1 2026-09-24; biased low, not re-derived). In 2020 the bounce came after the gap, not before the roll |
...
- The **21-DTE leg** is answered: `run_21dte_exit_test.py`. It includes SPY (n 242), at real fills, as a **20Δ
  strangle**. ~~The rule helps, t 4.26 pooled, but the trade is negative in both arms~~ (corrected 2026-09-24, FIX-1: original run dropped worthless-expiry winners). Fixed: the rule
  cuts risk but **costs return** (−$0.52/share vs hold, t −2.42 pooled); held ≈ flat (+$0.23/share).
