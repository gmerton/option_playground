...
| 4 | Momentum-skew vertical | Skew z ≤ −1.5 in the momentum direction; CS decile ≥8 / ≤3; liq ≥5-20k | Buy 45-60Δ, sell 10-25Δ; 10-20 DTE; 1-3-2 fly variant | 0.5-2%/trade | Hold to expiry; ≥90% max early; close before earnings | ⚠ **2026-09-16 review: evidence VOID** — the GBM sim assumes the lognormal distribution the thesis says is wrong, so +23% EV is the size of the smile by construction, biased favourably (fatter left tail = more total losses); drift sensitivity shows it is directional despite the claim; member wins cherry-picked. Conviction 2/5 | Fits Gabe's momentum names; our vehicle study: verticals trade winners for smaller losses | ✅ **TESTED 2026-09-16: mechanism real (+15.3pp conditional on the move), strategy rejected (monthly t 0.1; top 1% of trades = 52% of ROC; ungated control is better). 2/5** |
