...
| 63:55 | 45 DTE maximises theta per unit of gamma; manage at 14–21 DTE (other strategies) | ⏳ **Pending.** The 21-DTE strangle test is **under correction**: it dropped its worthless-expiry winners, and the re-run is scheduled 2026-09-24 ([FIX-1], TEST_INDEX §1/§10). Cite nothing from it until the fixed run lands |
