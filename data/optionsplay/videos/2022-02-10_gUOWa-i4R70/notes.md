...
| 42:00, 55:00 | Take profit at ~50–65%, don't wait to expiry | **AGREES (50%, ETF put spreads)** | `etf_put_spread_exit_rule_2026-09-16.md`: 45 DTE 0.35/0.25, 50% take, no stop, **+5.70%/trade, monthly t 3.13** after the ceiling-filter erratum. 65% is untested |
