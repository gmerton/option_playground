...
> `run_tierc_significance.py`: **+3.2%, insignificant** net of costs, month-clustered — does not clear the bar. The headline ROC/win-rate below is **mid-priced** and is the artefact pattern that killed every small-credit spread in this book (UVIX: +11%/93% win at mid → −8.8% at fills).
