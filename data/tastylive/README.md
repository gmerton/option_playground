...
| 2026-09-24 | Sosnoff + Thomas, "Why I Just Changed My Scalping Strategy After 20 Years" (2025-08-01, KkoWNrWSQlI) | intraday range percentiles by futures product; Sosnoff: **fade inside the normal range, go with the move beyond ~1 SD** | **2.5/5** | Range study descriptive (no trades). Follow-the-extreme half = noise-band momentum: right sign, **negative-gamma days t 2.92 UNDERPOWERED**; fade half untested directionally but its options form (positive-gamma 1-day SPY straddle/fly) is certified. On-set contradiction: "odds of further extension are low" vs "go with it" | [notes](videos/research/2025-08-01_KkoWNrWSQlI/notes.md) |
