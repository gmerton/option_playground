...
- ⚠ **TEST_INDEX row inconsistency:** the Freedom Income row quotes the 21-DTE arms as "−$0.46 vs −$1.77". The
  ...
  n 14,367): hold **+$0.23**, 21-DTE **−$0.29**, diff **−$0.52, t −2.42** per share (honest subset excluding 1,311 expiry-day B buybacks: −$0.51, t −2.04, hold +$0.43). The AMZN / ROC / median
