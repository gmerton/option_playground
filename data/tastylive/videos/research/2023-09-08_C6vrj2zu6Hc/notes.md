...
| 18:04–18:33 | Close at least three weeks before expiry | ✅ **Agrees on risk only; on return NULL, leaning the wrong way.** The 21-DTE test ~~paired +$1.53/strangle, t 4.26, both arms negative~~ (corrected 2026-09-24, FIX-1: original run dropped worthless-expiry winners): re-run n 14,367, 21-DTE close − hold **−$0.52/share, t −2.42**; hold +$0.23, 21-DTE −$0.29; sd $17.09 → $9.33, worst −$617 → −$291 (`exit_21dte_2026-09-23_fixed.csv`) | dup (OptionsPlay 21-DTE) |
| 18:33–20:15 | Narrow-condor P&L becomes binary and volatile in the last 2–3 weeks | ✅ Agrees mechanically: that's gamma. It's also the stated rationale of the 21-DTE rule, whose test cut the sd ~45% (at a return cost, corrected 2026-09-24 FIX-1) | new |
