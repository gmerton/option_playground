...
| 04:42–05:00 | You can change duration, manage early, hedge | **None certifies on return.** 21-DTE management on 45/20Δ strangles: ~~paired +$1.53, t 4.26; both arms negative~~ (corrected 2026-09-24, FIX-1: original run dropped worthless-expiry winners); fixed (TEST_INDEX §1, `exit_21dte_2026-09-23_fixed.csv`, n 14,367): B − A **−$0.52/share, t −2.42**, A +0.23, B −0.29 — it cuts risk (sd $17.09 → $9.33), not losers. Every management rule that conditions on P&L is INVERTED (BE+1R −0.08R; "extended→tighten" −0.19R t −2.8; roll test 69.8% better held) | dup of OptionsPlay 21-DTE |
