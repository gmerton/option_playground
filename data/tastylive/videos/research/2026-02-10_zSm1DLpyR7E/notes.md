...
| 06:29 / 11:31 | 21-DTE management cuts POT by >50% | ⚠ **Mostly mechanical** (24 of 45 days observed). The P&L version is ours: **21-DTE management on a 45 DTE / 20Δ strangle PASS, paired +$1.53/share, t +4.26, sd halved**, but **both arms lose** (held −$2.55, managed −$1.02/share; SPY −$1.77 / −$0.46). Verified at `data/studies/exit_21dte_2026-09-23.csv`. Their claim and ours agree on the shape (less path risk). Neither video shows the managed trade's absolute P&L. |
