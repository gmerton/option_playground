...
| 08:17–08:27 | "Doing something is better than doing nothing… nothing from our research has ever shown anything different" | ❌ **Too broad, and our ledger contradicts it for most "somethings".** Every P&L-conditioned exit we've tested is negative. The **21-DTE time exit**, once filed as certified (+$1.53/strangle, t 4.26), removes gamma symmetrically at a fixed date. ⚠ Re-run 2026-09-24 (FIX-1, the both-worthless winners restored): **PASS retracted**, −$0.52/share vs hold, t −2.42 — it cuts risk and costs return. It doesn't react to the loser. On our data, "do something" helps only when the something isn't conditioned on P&L |
