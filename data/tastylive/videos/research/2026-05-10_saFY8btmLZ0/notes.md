...
| 05:24 | 25Δ earns 1.16% of BP per trade vs 0.49% for 5Δ | ⚠ **Excludes outliers**, and it's likely at mid. Our nearest: SPY 20Δ managed at 21 DTE, real fills, **−$0.46/share over 2018–2025** and **+$0.225/share (t 1.91) from May 2020** (descriptive slice; ⚠ both from the retracted winner-depleted run, FIX-1 2026-09-24, not re-derived — the fixed 44-name panel has managed −$0.29, held +$0.23/share). The sign depends on whether 2020 is in the sample, and that's precisely the "outlier" they set aside. |
