...
| 13:38–13:47 | "If you can… shift your delta and adjust your delta as it moves, you can really get out of harm's way" | ❌ **Unfalsifiable as stated.** Our exit and management ledger: every P&L-conditioned adjustment tested is negative. The fixed-date 21-DTE exit, once filed as certified (+$1.53, t 4.26), was RETRACTED on re-run: −$0.52/share vs hold, t −2.42, a risk reducer only (corrected 2026-09-24, FIX-1: original run dropped worthless-expiry winners). "Get out of harm's way" by rolling toward the money adds gamma |
