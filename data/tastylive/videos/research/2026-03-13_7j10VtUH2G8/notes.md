...
| 07:24 vs 13:04/13:21 | Tail losses tighten in high IV / the distribution is wider in high IV / average losses are wider in low IV | ⚠ **Self-contradictory**; can't be scored as stated. Our nearest measurement: the 21-DTE study's SPY held arm lost **−$8.48/share on average in 2020 entries** vs ≈ 0 in 2021–22 (`exit_21dte_2026-09-23.csv`, 20Δ, real fills; ⚠ from the retracted run that dropped worthless-expiry winners, FIX-1 2026-09-24 — the per-year means are biased low, not re-derived). The high-IV year had the tail, which cuts against "tails tighten". |
